                ...
                <div className="project">
                    <div className="project__header">
                        <div className="project__title">
                            Project Planning <StarIcon className="star-icon" style={{strokeWidth: "1",width: "1.875rem", height: "1.875rem", marginLeft: "1rem", fill: "#e6e9ef", stroke: "#e6e9ef"}} />
                        </div>
                        <div className="project__integrate">
                            ...
                            <a href="index.html" className="project__button project__button--secondary">
                                <UsersIcon style={{strokeWidth: "1",width: "1rem", height: "1rem"}} />/ <span>1</span>
                            </a>
